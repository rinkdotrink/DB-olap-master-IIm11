...
\begin{enumerate}
\item \textbf{K1 und K2} \\ 
Der Kaltstart ohne Index(\textbf{K1}) gegenüber dem Warmstart ohne Index(\textbf{K2}) hat keinen Geschwindigkeitsvorteil gebracht. Die Werte unterscheiden sich nur sehr gering voneinander. Es kann an der geringen Komplexität der Statements und der kleinen Anzahl von Tabellen liegen, da das Parsen dadurch nicht viel zeitaufwändiger ist. Wahrscheinlich liegt aber an den großen Tabellen und an dem kleinen Query-Cache von nur XXXX. 
\item \textbf{K3 und K4} \\ 
