...
\section{Testdurchführung}\label{Testdurchfuehrung}

\subsection{Annahmen und Vorüberlegungen}\label{Annahme}
\begin{enumerate}
\item \textbf{K1 und K2} \\ 
Zuerst wurde zweimal ein Kaltstart ohne Index(\textbf{K2}) durchgeführt, um Referenzwerte zu bekommen, bevor die Testläufe mit der Indizierung und Partitionierung begonnen werden. Alle nachfolgenden Messungen wurden ebenfalls mit einem deaktivierten Query-Cache durchgeführt, damit die Messwerte, die abhängig von der Größe der Kundentabelle sind, durch das Zwischenspeichern nicht verfälscht werden. 
