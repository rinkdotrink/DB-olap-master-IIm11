...
\thispagestyle{empty} 
 ...
 Ingo Körner (40586)\\}
 \vspace{1cm}
 {\normalsize  Görlitz, 3. Februar 2012\\}
 \vspace{0.5cm}
...
\bibitem{bib5}{Schwartz, Baron. (2008): High Performance MySQL. O'REILLY}
...
\input{Christof/Architektur}
\input{Christof/Optimierung}
\chapter{Performancetest}\label{Performancetest}
\input{Christof/Performancetest} 
